!(function (e) {
  ...
  function (e, t, n) {
    ...
    var a = n(1),
      ...
      l = n(3),
      c = n(4)
    t.defaultScrollOptions = { transitionTime: 1e3, goToTopOnLast: !0, mediaQuery: 'screen', slideSelector: 'section' }
    var u = (function (e) {
      function n(n, r) {
        ...
        if (
          ...
          (o.goToSlide = function (e) {
            if (!(e === o.currentSlide || e < 0)) {
              ...
              if (!1 === o.waitForAnimation) {
                ...
                var n = 100 * -e
                ;(o.currentSlide = e),
                  (o.wrapperElement.style.transform = 'translateY(' + n + 'vh)'),
                  o.dispatchEvent(t),
                  setTimeout(function () {
          ...
          n instanceof HTMLElement ? (o.wrapperElement = n) : 'string' == typeof n && (o.wrapperElement = document.getElementById(n)),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.defaultWheelOptions = { newScrollThreshold: 400 })
    var o = (function () {
  ...
  function (e, t, n) {
    ...
    function s(e, t) {
      r.set(this, { eventTarget: e, event: t, eventPhase: 2, currentTarget: e, canceled: !1, stopped: !1, immediateStopped: !1, passiveListener: null, timeStamp: t.timeStamp || Date.now() }), Object.defineProperty(this, 'isTrusted', { value: !1, enumerable: !0 })
    ...
    ;(s.prototype = {
      ...
      Object.defineProperty(s.prototype, 'constructor', { value: s, configurable: !0, writable: !0 }),
        ...
        (function (e) {
          return {
            ...
            set(t) {
              ...
              if (null !== t) {
                const o = { listener: t, listenerType: f, passive: !1, once: !1, next: null }
    ...
    function y(e) {
      ...
      t.prototype = Object.create(b.prototype, { constructor: { value: t, configurable: !0, writable: !0 } })
    ...
    ;(b.prototype = {
      addEventListener(e, t, n) {
        ...
        const r = g(this),
          ...
          a = { listener: t, listenerType: i, passive: o && Boolean(n.passive), once: o && Boolean(n.once), next: null }
        let s = r.get(e)
      ...
      dispatchEvent(e) {
        ...
        let a = null
        for (; null != r; ) {
          if ((r.once ? (null !== a ? (a.next = r.next) : null !== r.next ? t.set(n, r.next) : t.delete(n)) : (a = r), d(o, r.passive ? r.listener : null), 'function' == typeof r.listener))
            try {
      ...
      'undefined' != typeof window && void 0 !== window.EventTarget && Object.setPrototypeOf(b.prototype, window.EventTarget.prototype),
